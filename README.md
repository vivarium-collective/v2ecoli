...
<!-- generated by scripts/gen_readme.py — edit the source, not this table -->
...
Every composite generator registered under `v2ecoli/composites/` is listed
below. All share the same biological processes; they differ in how cells are
scheduled and embedded. Browse and explore any of them — wiring graph included —
on the dashboard's [Composites page](https://vivarium-collective.github.io/v2ecoli/dashboard/#simulation-setup).
...
Reach any of these by name — `build_composite("<name>")`.
