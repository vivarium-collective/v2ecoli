...
def _import_local_model():
    ...
    a study folder, not an installed package). Path updated 2026-09-22 when
    the study moved from workspace/investigations/flagella-cascade/studies/
    (old, nested v2 layout) to the top-level workspace/studies/ (current
    schema, no-nested-study CI check)."""
