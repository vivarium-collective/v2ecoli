...
from v2ecoli.processes.parca.wholecell.utils.modular_fba import FluxBalanceAnalysis
...
class Test_FluxBalanceAnalysis(unittest.TestCase):
    ...
    def test_standard_noInput(self):
        ...
        for moleculeID, change in zip(
            fba.getOutputMoleculeIDs(), fba.getOutputMoleculeLevelsChange()
        ):
            if moleculeID == "B":
