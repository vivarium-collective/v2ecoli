...
SCALAR_ENUM_FIELDS: dict[str, str] = {
    ...
    # dnaA-investigation enums (registered when biology.py's dnaa
    # extension is loaded; skipped silently if not):
...
CONTEXTUAL_ENUM_FIELDS: list[tuple[str, str, str, str]] = [
    ...
    # dnaA-investigation specific (skipped silently when enums unregistered):
