...
try:
    ...
    _payload = {'spec_id': 'v2ecoli.composites.baseline_recipes.dnaa_02_with_intrinsic_hydrolysis', 'overrides': {'seed': 0, 'cache_dir': 'out/cache', 'mechanism': 'intrinsic', 'stage1_dnaa_expression': True}, 'run_id': 'v2ecoli.composites.baseline_recipes.dnaa_02_with_intrinsic_hydrolysis__1779421225__491422', 'db_file': '/Users/eranagmon/code/v2ecoli/.claude/worktrees/dnaa-mock-investigation-start/studies/dnaa-06-extrinsic-regulation/runs.db', 'steps': 3600, 'emit_paths': ['agents/0/listeners/dnaA_cycle/atp_fraction', 'listeners/dnaA_cycle/atp_fraction']}
