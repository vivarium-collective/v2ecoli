"""Process-bigraph partitioned process: chromosome_replication."""
...
class ChromosomeReplicationLogic:
    ...
    config_schema = {
        "get_dna_critical_mass": {"_default": None},
        "criticalInitiationMass": {"_default": None},
        "nutrientToDoublingTime": {"_default": {}},
        "replichore_lengths": {"_default": None},
        "sequences": {"_default": None},
        "polymerized_dntp_weights": {"_default": []},
        "replication_coordinate": {"_default": None},
        "D_period": {"_default": None},
        "replisome_protein_mass": {"_default": 0},
        "no_child_place_holder": {"_default": -1},
        "basal_elongation_rate": {"_default": 967},
        "make_elongation_rates": {"_default": None},
        "mechanistic_replisome": {"_default": True},
        # molecules
        "replisome_trimers_subunits": {"_default": []},
        "replisome_monomers_subunits": {"_default": []},
        "dntps": {"_default": []},
        "ppi": {"_default": []},
        # random seed
        "seed": {"_default": 0},
