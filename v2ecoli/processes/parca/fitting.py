"""
Fitting helpers shared across ParCa pipeline stages.

Split into two sections:

  * Pure math — no sim_data dependency, no side effects; operates only
    on explicit arguments (numpy arrays, units values).
  * sim_data-reading fitting — takes ``sim_data`` as a parameter and is
    shared by stages 3 (basal_specs), 4 (tf_condition_specs), and 5
    (fit_condition).  Future refactoring will decompose these into pure
...
# ===========================================================================
# sim_data-reading fitting helpers (merged from _fitting.py)
# ===========================================================================
