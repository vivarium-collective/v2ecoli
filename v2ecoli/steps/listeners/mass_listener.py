...
class MassListener(Step):
    ...
    def __init__(self, config=None, core=None):
        ...
        submass_to_idx = self.parameters.get("submass_to_idx", self.defaults["submass_to_idx"])
        ...
        # compartment indexes
        compartment_indices = self.parameters.get("compartment_indices", self.defaults["compartment_indices"])
    ...
    def ports_schema(self):
        ...
        ports = {
            ...
            "timestep": {"_default": self.parameters.get("time_step", 1.0)},
        }
        ports["unique"].update(
            {
