...
# ---------------------------------------------------------------------------
# Listener schema helper
# ---------------------------------------------------------------------------

def listener_schema(elements: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
    """Create port schemas for a collection of listeners.

    Values can be plain defaults or (default, metadata) tuples.
    """
    schema = {}
    for element, default in elements.items():
        if isinstance(default, tuple):
            ...
            schema[element] = {"_updater": "set", "_emit": True, "_default": default}
    return schema
