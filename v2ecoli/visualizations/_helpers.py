...
Public API:
    ...
    render_cytoscape_html(data, title, subtitle) -> str
...
def render_cytoscape_html(data: dict, title: str, subtitle: str) -> str:
...
def write_outputs(
    ...
    html_path.write_text(
        render_cytoscape_html(data, title, subtitle), encoding='utf-8'
    )
...
# ---------------------------------------------------------------------------
# New shared helpers (added in Task 1)
# ---------------------------------------------------------------------------
...
def group_by_generation(history: list[dict]) -> list[list[dict]]:
    """Group rows by integer ``generation`` key. Returns generations in order."""
