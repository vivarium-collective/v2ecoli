...
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.molecule_groups import MoleculeGroups
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.molecule_ids import MoleculeIds
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.constants import Constants
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.common_names import CommonNames
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.state.internal_state import InternalState
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.state.external_state import ExternalState
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.process.process import Process
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.growth_rate_dependent_parameters import (
    Mass,
    GrowthRateParameters,
)
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.relation import Relation
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.adjustments import Adjustments
