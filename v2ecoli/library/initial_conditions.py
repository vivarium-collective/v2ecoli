...
def initialize_unique_molecules(
    ...
    # Only populate when the sim_data has plasmid unique-molecule definitions
    # (i.e. was generated by a plasmid-aware parca).
    if "full_plasmid" in sim_data.internal_state.unique_molecule.unique_molecule_definitions:
        if has_plasmid:
...
def initialize_replication(
    ...
    elif "oriV" in sim_data.internal_state.unique_molecule.unique_molecule_definitions:
    ...
    if "plasmid_active_replisome" in sim_data.internal_state.unique_molecule.unique_molecule_definitions:
