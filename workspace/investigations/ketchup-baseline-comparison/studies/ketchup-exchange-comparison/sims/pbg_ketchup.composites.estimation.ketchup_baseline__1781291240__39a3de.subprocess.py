...
try:
    ...
    _payload = {'spec_id': 'pbg_ketchup.composites.estimation.ketchup_baseline', 'overrides': {'model_name': 'k-ecoli307', 'seed': 0, 'solver_options': '/Users/eranagmon/code/v2e-ketchup-compare/v2ecoli/composites/ketchup_demo_ipopt.opt'}, 'run_id': 'pbg_ketchup.composites.estimation.ketchup_baseline__1781291240__39a3de', 'db_file': '/Users/eranagmon/code/v2e-ketchup-compare/studies/ketchup-exchange-comparison/runs.db', 'steps': 1, 'emit_paths': [], 'default_emitter': 'parquet', 'max_generations': 8, 'single_daughters': False, 'zarr_store': '/Users/eranagmon/code/v2e-ketchup-compare/studies/ketchup-exchange-comparison/runs.pbg_ketchup.composites.estimation.ketchup_baseline__1781291240__39a3de.zarr'}
