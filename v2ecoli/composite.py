...
def run_and_cache(cache_dir='out/cache', checkpoint_dir='out/checkpoints',
    ...
    Standard workflow: load from cache, run to various time points,
    save state at each. Useful for testing division without re-running.

    Args:
        cache_dir: Path to initial cache.
        checkpoint_dir: Where to save checkpoints.
        intervals: List of simulation times to checkpoint at.
            Default: [100, 500, 1000, 1500, 1800, 2000, 2500, 3000]
        seed: Random seed.
    ...
    for target in intervals:
        ...
        print(f'  t={target}: dry_mass={dm:.1f}, threshold={thresh}, '
