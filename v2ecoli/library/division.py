...
def divide_cell(cell_state, dividers=None):
    ...
    Args:
        cell_state: Dict with 'bulk', 'unique', 'environment', 'boundary', 'listeners'
            and any INJECTED agent-root stores ('fields', 'imposed_flux_bounds',
            'pg_cellwall', ...), plus (when flagella_nfsim_complexation is active)
