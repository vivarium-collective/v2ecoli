...
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.state.bulkMolecules import BulkMolecules
from v2ecoli.processes.parca.reconstruction.ecoli.dataclasses.state.uniqueMolecules import UniqueMolecules
