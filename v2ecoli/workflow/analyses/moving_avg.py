...
from viva_emitters.xarray_emitter.mapreduce import (
    Chain,
    MinMax,
    ReducerDistribute,
    ReducerMapping,
...
from viva_emitters.xarray_emitter.zarr_mapreduce import (
    CoordDescriptor,
    ZarrMapReduce,
    ZarrMapReduceConfig,
    ZarrMapReducePlot,
...
from viva_emitters.xarray_emitter.emit_predicate import (
...
from viva_emitters.xarray_emitter.utils import filter_warnings
from viva_emitters.xarray_emitter.zarr_utils import (
    get_ndarray,
...
if TYPE_CHECKING:
    ...
    from viva_emitters.xarray_emitter.mapreduce import Reducer
...
def main(args: Namespace | None = None) -> None:
    ...
    # define analysis pipeline (config dir = v2ecoli repo-root configs/)
    from v2ecoli.workflow.variants import parse_variant_params
    config_dir = Path(__file__).resolve().parents[2] / "configs"
    sim_cfg = WorkflowConfig.load(
        config_dir / args.config, variant_parser=parse_variant_params)
