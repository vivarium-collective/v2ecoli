    ...
    def outputs(self):
        return {
            ...
            'dnaa_hydrolysis': {
                ...
                # dnaa-4 autoregulation: dnaA-promoter occupancy fraction,
                # consumed by transcript_initiation.py. Emitted in update();
                # declared here so the output port is registered (kept from
                # the current branch's schema).
