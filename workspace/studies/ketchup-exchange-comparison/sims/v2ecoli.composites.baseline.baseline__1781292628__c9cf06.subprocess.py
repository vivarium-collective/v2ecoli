...
try:
    ...
    _payload = {'spec_id': 'v2ecoli.composites.baseline.baseline', 'overrides': {'cache_dir': 'out/cache'}, 'run_id': 'v2ecoli.composites.baseline.baseline__1781292628__c9cf06', 'db_file': '/Users/eranagmon/code/v2e-ketchup-compare/studies/ketchup-exchange-comparison/runs.db', 'steps': 4, 'emit_paths': [], 'default_emitter': 'parquet', 'max_generations': 8, 'single_daughters': False, 'zarr_store': '/Users/eranagmon/code/v2e-ketchup-compare/studies/ketchup-exchange-comparison/runs.v2ecoli.composites.baseline.baseline__1781292628__c9cf06.zarr'}
