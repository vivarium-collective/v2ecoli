...
def _fg(v) -> float:
    """Units-safe scalar read: pint Quantity (e.g. femtogram) -> magnitude;
    plain number -> float. The new-units model emits mass as a pint Quantity,
    so a bare float() raises DimensionalityError."""
