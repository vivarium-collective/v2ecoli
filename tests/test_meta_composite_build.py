...
def test_register_workflow_processes_resolves_address():
    ...
    # core.link_registry is where register_link stores classes (no process_registry in this
    # bigraph-schema version; core.access("LineageProcess") returns the string, not the class).
