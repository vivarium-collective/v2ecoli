...
from v2ecoli.processes.parca.ecoli.library.schema import (
    attrs,
    bulk_name_to_idx,
    counts,
    MetadataArray,
)
from v2ecoli.processes.parca.trna_charging import (
    calculate_trna_charging,
    REMOVED_FROM_CHARGING,
    MICROMOLAR_UNITS,
)
from v2ecoli.processes.parca.wholecell.utils import units
from v2ecoli.processes.parca.wholecell.utils.fitting import (
...
def initialize_replication(
    ...
    # dnaa-3: extend with the 8 oriC low-aff sites. Mirrors the same change
    # in v2ecoli/library/initial_conditions.py (cache-build path).
    ...
    # dnaa-3: tag each box with its pool by coordinate membership.
